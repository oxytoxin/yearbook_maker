...
class UserHomepage extends GetView<UserHomepageController> {
        ...
        drawer: Drawer(
          child: ListView(
            children: [
              ...
              ListTile(
                onTap: () {
                  Get.toNamed('/user/yearbooks_list');
                },
                title: const Text(
                  'Yearbooks List',
                  style: TextStyle(
